...
public class ComputerQuiz implements IQuiz {
	...
	public List<IQuestion> pickRandomQuestions(int length) {
		return Arrays.asList(
				...
				new Question(CATEGORY_PROGRAMMING,
						"Bluetooth technology allows ...?",
						"",
						Arrays.asList("Landline phone to mobile phone communication",
								"Signal transmission between two or more mobile phones only",
								"Wireless communication between equipments",
								"Satellite television communication"), 2)
								);
	}
